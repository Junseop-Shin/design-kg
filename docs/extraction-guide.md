...
| PREFERRED | ~하는 게 좋아요 · 훨씬 낫죠 · 추천드려요 · ~하면 더 · ~하시는 게 · ~하는 게 맞아요/맞죠 · ~하면 좋겠어요 · ~가 낫죠 · ~하시면 돼요 · ~해야 될 것 같아요 (의무 + 것 같다) |
...
의무를 말하는 꼴이면 표면형이 달라도 PRESCRIPTIVE다 — `~해야 돼요` · `~돼야 돼요` · `~되어야 합니다` · `~돼야 되는 거예요`처럼 `해야/돼야/되어야 + 되다/하다`가 들어가면 전부. 단 `~해야겠구나`처럼 -겠-이 붙은 혼잣말은 지시가 아니므로 PRESCRIPTIVE가 아니다.

`~해야 될 것 같아요`처럼 의무 표현에 `것 같다`가 붙으면 PREFERRED다. 의무를 말하지만 확신을 뺀 것이다.
